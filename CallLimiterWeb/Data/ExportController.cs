...
namespace CallLimiterWeb.Data
{
    public partial class ExportController : ControllerBase
	{
        ...
        private static void GenerateWorkbookStylesPartContent(WorkbookStylesPart workbookStylesPart1)
        {
			...
			SpreadsheetDocument? doc = workbookStylesPart1.OpenXmlPackage as SpreadsheetDocument;
			WorkbookPart? workbookPart = doc?.WorkbookPart;
			OpenXmlUnknownElement? openXmlUnknownElement4 = workbookPart?.CreateUnknownElement("<x15:timelineStyles defaultTimelineStyle=\"TimeSlicerStyleLight1\" xmlns:x15=\"http://schemas.microsoft.com/office/spreadsheetml/2010/11/main\" />");

			//stylesheetExtension2.Append(openXmlUnknownElement4);

			if (openXmlUnknownElement4 != null)
			{
				stylesheetExtension2.Append(openXmlUnknownElement4);
			}
